            ...
            <table class="min-w-full divide-y divide-slate-100">
                <thead class="bg-slate-50/75">
                    <tr>
                        ...
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-slate-500">Nama Institusi / Aplikasi</th>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    @forelse($links as $link)
                        <tr class="hover:bg-slate-50/60 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex h-12 w-20 items-center justify-center rounded-xl border border-slate-200 bg-slate-50 p-1">
                                    @if($link->logo_url)
                                        <img src="{{ $link->logo_url }}" alt="{{ $link->name }}" class="h-8 w-auto max-w-full object-contain">
                                    @else
                                        <i data-feather="link-2" class="h-4 w-4 text-slate-400"></i>
                                    @endif
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    <button
                                        type="button"
                                        class="btn-icon btn-edit-link text-amber-600 hover:bg-amber-50"
                                        title="Edit Link"
