...
2. Use existing components: `<x-admin.modal>`, `<x-admin.page-header>`, `<x-admin.stat-card>`, `<x-admin.badge>`, `<x-admin.form-input>`, `<x-admin.card>`, `<x-admin.empty-state>`, `<x-admin.btn-primary>`, `<x-admin.btn-danger>`, `<x-admin.image-preview>`, etc.
